...
\begin{frame}{Interpretation}
    \begin{block}{Recap}
        Utilitarianism and Hedonism and motivated by maximising goodness. \\
        The other three principles are motivated by harm reduction.
    \end{block}
    Utilitarianism is "stronger" (always selects a plan), while Hedonism is "weaker" (rejects non-improving plans).\\
    Harm Avoidance is the strictest but may be too restrictive in real-world dilemmas.
\end{frame}
